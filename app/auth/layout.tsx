...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      ...
      <div className="w-full max-w-5xl relative z-10 grid md:grid-cols-[1fr_420px] overflow-hidden rounded-[28px] border" style={{borderColor:'var(--border-default)', background:'rgba(17,25,39,0.9)', boxShadow:'var(--page-shadow)'}}>
        <div className="hidden md:flex flex-col justify-between px-10 py-12" style={{borderRight:'1px solid var(--border-subtle)', background:'linear-gradient(180deg, rgba(18,28,44,0.96) 0%, rgba(11,17,32,0.96) 100%)'}}>
          <div>
